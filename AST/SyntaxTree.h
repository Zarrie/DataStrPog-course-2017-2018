...
public:
	...
	SyntaxTree(const SyntaxTree& rhs) = delete;
	SyntaxTree& operator=(const SyntaxTree& rhs) = delete;
	...
	friend std::ostream& operator << (std::ostream &out, const SyntaxTree &tree){
...
unsigned int SyntaxTree::Node::maxID = 0;
